...
const LaundryPage = ({ navigation, route }) => {
    ...
    const handleSubmit = () => {
        ...
        navigation.navigate('OrderSummary', { bookings });
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={[styles.addButton, { backgroundColor: '#6f42c1' }]} onPress={handleAddBooking}>
                <Text style={styles.addButtonText}>Add Laundry</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.submitButton, { backgroundColor: '#6f42c1' }]} onPress={handleSubmit}>
                <Text style={styles.submitButtonText}>See Booked Laundry's</Text>
            </TouchableOpacity>
        </View>
    );
};
